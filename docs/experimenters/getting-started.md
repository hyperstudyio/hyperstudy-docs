...
# Getting Started as an Experimenter
...
1. Visit [hyperstudy.io/auth/experimenter](https://hyperstudy.io/auth/experimenter)
...
![Registration Screen](/img/experimenters/registration.png)
_Experimenter registration and login screen_
...
- [States and Flows](./experiment-design/experiment-states.md)
- [Working with Variables](./experiment-design/variables.md)
- [Managing Roles](./experiment-design/roles.md)
- [Available Components](./experiment-design/components/index.md)
- [Recruitment Settings](./recruitment/settings.md)
